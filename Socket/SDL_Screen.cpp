...
SDL_Screen::SDL_Screen(char* Name, int Screen_w, int Screen_h)
{
    name = Name;
    screen_w = Screen_w;
    screen_h = Screen_h;
...
SDL_bool SDL_Screen::init() {
    ...
    frame_size.height = screen_h;
    frame_size.width = screen_w;
...
void SDL_Screen::uploadTexture(const Uint8* Yplane, int Ypitch,
